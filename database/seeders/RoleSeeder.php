...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $veterinario?->syncPermisos($this->idsDesdeEnums([
            ...
            PermisoEnum::LISTAR_ESPECIES,
            PermisoEnum::CREAR_ESPECIES,
            PermisoEnum::EDITAR_ESPECIES,
            PermisoEnum::VER_ESPECIES,
            PermisoEnum::LISTAR_RAZAS,
            PermisoEnum::CREAR_RAZAS,
            PermisoEnum::EDITAR_RAZAS,
            PermisoEnum::VER_RAZAS,
            PermisoEnum::LISTAR_VETERINARIOS,
            PermisoEnum::CREAR_VETERINARIOS,
            PermisoEnum::EDITAR_VETERINARIOS,
            PermisoEnum::VER_VETERINARIOS,
